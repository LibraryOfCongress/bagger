...
public class WorkflowConstants {
	...
	public static final String VARIABLE_LAST_EXCEPTION_NODENAME = "lastExceptionNodeName";
	public static final String VARIABLE_LAST_EXCEPTION_ACTIONNAME = "lastExceptionActionName";
