...
public class BagTableFormBuilder extends TableFormBuilder {
  ...
  public JComponent[] addList(String fieldName, boolean isRequired, String label, Collection<String> elements, String defaultValue,
                              JComponent checkbox, String attributes) {
  ...
  public JComponent[] addBinding(String fieldName, boolean isRequired, String labelName, JComponent component, JComponent wrappedComponent,
                                 JComponent removeButton, String attributes, String labelAttributes) {
