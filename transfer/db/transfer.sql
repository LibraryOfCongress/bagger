...
create table tickets (
    ...
    requester           varchar(32) references users,
...
create table locations (
    ...
    system_name    varchar(32)  not null references systems,
    file_owner     varchar(16), 
    hostname       varchar(32)  not null, 
    root_directory varchar(255) not null,
    role           varchar(32)  not null references location_roles,    
...
INSERT INTO event_types VALUES ('fixity verification');
INSERT INTO event_types VALUES ('package registration');
INSERT INTO event_types VALUES ('workspace copy');
INSERT INTO event_types VALUES ('archive copy');
INSERT INTO event_types VALUES ('location registration');
INSERT INTO event_types VALUES ('purge workspace copy');
...
INSERT INTO event_status VALUES ('started');
INSERT INTO event_status VALUES ('waiting'); -- a busy wait for a resource
INSERT INTO event_status VALUES ('warning');
INSERT INTO event_status VALUES ('completed');
INSERT INTO event_status VALUES ('pass');
INSERT INTO event_status VALUES ('fail');
...
create table events (
    ...
    event_type      varchar(32) not null references event_types,
    event_status    varchar(32) not null references event_status,
    system_name     varchar(32)  not null references systems,
    hostname        varchar(32)  not null, 
    root_directory  varchar(255) not null,
    event_details   text
