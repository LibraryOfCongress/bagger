...
class PackageModeler(AbstractDB):
    def __init__(self, config):
        ...
        self.url = 'https://beryllium.rdc.lctl.gov/trac/ndnptransfer/browser/trunk/%s/release/%s-%s-bin.zip?format=raw' % (self.project_name, self.project_name, self.version)
