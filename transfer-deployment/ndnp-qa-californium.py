...
config = {
    ...
    'WORKFLOW_NDNP_PROPS': {
        'storage.staging.ndnp.basedirectory':'/vol/ndnp/transfer_qa/staging',
        'storage.archive.ndnp.basedirectory':'/vol/ndnp/transfer_qa/archive',
	'storage.archive.ndnp.user':'justin',
	'storage.archive.ndnp.group':'justin',
    'storage.staging.ndnp.user':'qatransfer',
    'storage.staging.ndnp.group':'datandnp',    
    },
    'UI_PROPS': {
        'healthcheck.servicecontainers.hosts':'einsteinium,cobalt',
    }
}
